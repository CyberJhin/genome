...
[DIV-004–DIV-005](GENETIC_DIVERSITY_MODEL.md) уточняют: наследование и рекомбинация комбинируют родительские alleles/участки, не создавая произвольных новых alleles. Можно закреплять отдельные признаки, повторять удачную пару и получать одинаковые генотипы/фенотипы. При одинаковых генетических данных, применимых условиях и версии правил распределение исходов пары сохраняется; история удач/неудач сама его не меняет. Повторение A × B не увеличивает родство самих A и B; pedigree calculation остаётся OPEN (OQ-008).

Осмысленный подбор родителей должен быть выгоднее случайного; закреплённый признак не гарантирует всей желаемой сборки. Нельзя искусственно менять закреплённый locus ради неожиданности или раскрывать неотсеквенированные alleles точным прогнозом. Неполное знание и вероятности остаются OPEN (OQ-002, OQ-014). Основание: [Update 001](../updates/GENOME_CANON_UPDATE_001.md); темп потомства и существующие числовые параметры не меняются.
