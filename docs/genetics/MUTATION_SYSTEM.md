...
Согласно [DIV-004](GENETIC_DIVERSITY_MODEL.md), мутация — отдельное изменение наследуемого материала по явным переходам. Она может не произойти, дать желаемый, иной вариант или недостаток; полезность зависит от цели. Она не перегенерирует организм и не заменяет подбор родителей случайной выдачей редкости. Не вводятся гарантированная N-я мутация, подмена результата ради вовлечения или обязательный утешительный результат.

Основание: [Update 001](../updates/GENOME_CANON_UPDATE_001.md). Текущие rates, переходы и targets ниже не меняются и не становятся завершённой моделью; OQ-007 остаётся OPEN. Надёжное наследование закреплённого locus без соответствующей мутации не нарушает принцип вариативности.
