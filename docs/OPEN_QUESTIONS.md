...
Вопросы baseline и CANON UPDATE 001–005. Update 001 уточнил OQ-017 и добавил OQ-020–OQ-024; Update 002 частично уточнил OQ-021–OQ-023; Update 003 согласовал качественные правила специализации в OQ-023, сохранив численные и алгоритмические детали OPEN. Update 004 частично уточняет OQ-023–OQ-024 и добавляет в OQ-022 ссылку на тайминг. Update 005 частично уточняет OQ-022–OQ-024 и добавляет в OQ-021 различие переноса потери здоровья и перехвата атаки. Ни один вопрос не закрыт; новых дублирующих вопросов не добавлено. Указание APPROVED v0.1 у блока не снимает перечисленные ограничения. GDS и DB означают сохранённые [Game Design Spec](source/GENOME_GAME_DESIGN_SPEC_v0.1.md) и [Domain Bible](source/GENOME_DOMAIN_BIBLE_v0.1.md). Каталог — [data/genome_v1.yaml](../data/genome_v1.yaml). Нужен явный CANON UPDATE; значения и примеры пока сохранены без исправления.
