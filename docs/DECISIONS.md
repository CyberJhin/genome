...
Реестр уже принятых решений baseline v0.1 и CANON UPDATE 001–003. Это не новое утверждение спорных деталей. Числовые targets, примеры, DRAFT-блоки и неполные формулы не превращаются здесь в окончательные решения.
